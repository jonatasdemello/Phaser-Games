...
BunnyDefender.Game.prototype = {
    ...
    buildBunnies: function() {
        ...
        for(var i=0; i<this.totalBunnies; i++) {
            ...
            b.body.moves = false; // allow us to control bunnies manually
            b.animations.add('Rest', this.game.math.numberArray(1,58)); // frames state
    ...
    assignBunnyMovement: function(b) {
        bposition = Math.floor(this.rnd.realInRange(50, this.world.width-50)); // next bunny position
